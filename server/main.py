...
_translation = importlib.import_module("translation")
build_error_solution_fallback = _translation.build_error_solution_fallback
build_text_translation_fallback = _translation.build_text_translation_fallback
contains_prompt_injection = _translation.contains_prompt_injection
extract_gemini_text = _translation.extract_gemini_text
find_related_glossary_terms = _translation.find_related_glossary_terms
translate_text_with_gemini = _translation.translate_text_with_gemini

_curated_reasons = importlib.import_module("curated_reasons")
CURATED_REASON_CATEGORY_MATCH = _curated_reasons.CURATED_REASON_CATEGORY_MATCH
CURATED_REASON_CONTEXTUAL_MATCH = _curated_reasons.CURATED_REASON_CONTEXTUAL_MATCH
CURATED_REASON_HIGH_QUALITY = _curated_reasons.CURATED_REASON_HIGH_QUALITY
CURATED_REASON_KOREAN_DEV_MATCH = _curated_reasons.CURATED_REASON_KOREAN_DEV_MATCH
CURATED_REASON_LANGUAGE_MATCH = _curated_reasons.CURATED_REASON_LANGUAGE_MATCH
CURATED_REASON_LABELS = _curated_reasons.CURATED_REASON_LABELS
CURATED_REASON_RECENT_UPDATE = _curated_reasons.CURATED_REASON_RECENT_UPDATE
CURATED_REASON_TAG_OVERLAP = _curated_reasons.CURATED_REASON_TAG_OVERLAP
CURATED_REASON_UNKNOWN = _curated_reasons.CURATED_REASON_UNKNOWN
format_curated_reason_label = _curated_reasons.format_curated_reason_label
get_curated_reason_label = _curated_reasons.get_curated_reason_label
normalize_curated_reason_code = _curated_reasons.normalize_curated_reason_code
