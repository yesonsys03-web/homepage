...
import { AdminTabHeader } from "@/components/screens/admin/AdminTabHeader"
...
export function AdminScreen({ onNavigate }: ScreenProps) {
  ...
  const reportsQueryKey = useMemo(
    () => ["admin-reports", activeStatus, reportPage, REPORT_PAGE_SIZE] as const,
    [activeStatus, reportPage],
  )
  ...
  const loadReports = useCallback((page: number = 0) => {
    setReportPage(page)
  }, [])
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as AdminTabKey)}>
          ...
          <AdminReportsTab
            ...
            areAllFilteredProjectsSelected={areAllFilteredProjectsSelected}
            toggleSelectAllFilteredProjects={toggleSelectAllFilteredProjects}
